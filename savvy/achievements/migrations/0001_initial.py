...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Goal'
        db.create_table('achievements_goal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='goals', to=orm['lessons.Unit'])),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='goals', to=orm['badger.Badge'])),
        ))
        db.send_create_signal('achievements', ['Goal'])


    def backwards(self, orm):
        
        # Deleting model 'Goal'
        db.delete_table('achievements_goal')


    models = {
        'achievements.goal': {
            'Meta': {'object_name': 'Goal'},
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'goals'", 'to': "orm['badger.Badge']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'goals'", 'to': "orm['lessons.Unit']"})
        },
        'auth.group': {
