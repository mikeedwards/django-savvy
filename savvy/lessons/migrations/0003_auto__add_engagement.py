...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lessons_engagement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='engagements', to=orm['auth.User'])),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='engagements', to=orm['lessons.Assignment'])),
        ))
        db.send_create_signal('lessons', ['Engagement'])


    def backwards(self, orm):
        
        # Deleting model 'Engagement'
        db.delete_table('lessons_engagement')
