...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assessment.points_awarded'
        db.add_column('lessons_assessment', 'points_awarded', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Assessment.has_awarded'
        db.add_column('lessons_assessment', 'has_awarded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assessment.points_awarded'
        db.delete_column('lessons_assessment', 'points_awarded')

        # Deleting field 'Assessment.has_awarded'
        db.delete_column('lessons_assessment', 'has_awarded')
    ...
    models = {
        ...
        'lessons.assessment': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Assessment'},
            'assessor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assessment'", 'to': "orm['auth.User']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'engagement': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assessments'", 'to': "orm['lessons.Engagement']"}),
            'field_data': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'null': 'True', 'blank': 'True'}),
            'has_awarded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'points_awarded': ('django.db.models.fields.FloatField', [], {'default': '0.0'})
        },
        'lessons.assignment': {
            'Meta': {'object_name': 'Assignment'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'hide_until_start': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'assignments'", 'symmetrical': 'False', 'through': "orm['lessons.Engagement']", 'to': "orm['auth.User']"}),
            'worksheet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assignments'", 'to': "orm['lessons.Worksheet']"})
        },
        'lessons.engagement': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Engagement'},
            'assignment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'engagements'", 'to': "orm['lessons.Assignment']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'field_data': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'engagements'", 'to': "orm['auth.User']"})
        },
