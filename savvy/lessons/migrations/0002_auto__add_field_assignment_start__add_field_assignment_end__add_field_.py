...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.start'
        db.add_column('lessons_assignment', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Assignment.end'
        db.add_column('lessons_assignment', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Assignment.hide_until_start'
        db.add_column('lessons_assignment', 'hide_until_start', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.start'
        db.delete_column('lessons_assignment', 'start')

        # Deleting field 'Assignment.end'
        db.delete_column('lessons_assignment', 'end')

        # Deleting field 'Assignment.hide_until_start'
        db.delete_column('lessons_assignment', 'hide_until_start')
