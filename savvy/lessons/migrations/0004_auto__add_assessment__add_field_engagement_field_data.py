...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lessons_assessment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('assessor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assessment', to=orm['auth.User'])),
            ('engagement', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assessments', to=orm['lessons.Engagement'])),
            ('field_data', self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('lessons', ['Assessment'])

        # Adding field 'Engagement.field_data'
        db.add_column('lessons_engagement', 'field_data', self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Assessment'
        db.delete_table('lessons_assessment')

        # Deleting field 'Engagement.field_data'
        db.delete_column('lessons_engagement', 'field_data')
