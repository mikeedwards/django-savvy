...
from lessons.views import PlanDetailView, TakeDetailView, GradeDetailView
...
urlpatterns = patterns('',
    ...
    url(r'^eval/$','lessons.views.eval',name='lessons_eval'),
    url(r'^$','lessons.views.index',name='lessons_index'),
)